...
const SECTORS = [
  ["Arco", "Massone", "Arco's most popular wall: a vast sweep of vertical to gently overhanging limestone with fast access and afternoon shade. Dozens of single-pitch routes pack the cliff, from polished slab classics to crimpy testpieces, making it the perfect place to clock up mileage."],
  ["Arco", "Policromuro", "A steep, colourful cave sector that stays dry in the rain — Arco's go-to crag when the weather turns. Powerful, three-dimensional climbing on orange tufas, pockets and the occasional jug rewards good footwork and a strong core."],
  ["Kalymnos", "Grande Grotta", "Kalymnos's iconic cave: an enormous orange amphitheatre hung with giant stalactites and tufa blobs. The climbing is wildly steep and photogenic, with kneebars and rests hidden among the features — home to some of the island's most famous routes."],
  ["Kalymnos", "Odyssey", "Vertical to slightly overhanging grey walls with morning shade and sweeping sea views. Clean, positive holds and generous bolting make Odyssey a friendly, popular sector through the mid grades."],
  ["Fontainebleau", "Bas Cuvier", "The historic heart of Fontainebleau bouldering, where many of the sport's classic testpieces and brutal slopers were first established. Polished, technical and steeped in history, its problems still humble climbers of every level."],
  ["Fontainebleau", "Franchard Isatis", "A scenic Font sector of slabs, aretes and a famous traverse circuit set among the pines. The sandstone is impeccable and the problems range from delicate footwork to powerful compression."],
  ["Leonidio", "Hot Rock", "South-facing orange tufas high above the village, sustained and sunny. Long, athletic lines weave between hanging stalactites — a brilliant spot on cool winter days."],
  ["Leonidio", "Mars", "Vertical grey and red walls offering technical, crimpy climbing with morning shade. The holds are small and the movement precise, making it a favourite for face-climbing specialists."],
  ["Céüse", "Berlin", "The classic introduction to Céüse's blue limestone — vertical pockets and crimps on impeccable rock. Sustained and technical, these lines are the perfect warm-up before the cliff's harder neighbours."],
  ["Céüse", "Biographie", "Céüse's most famous wall, home to some of the hardest sport pitches ever climbed, including Sharma's Biographie. Steep, relentless and historic, it draws strong climbers from around the world."],
  ["Finale Ligure", "Bric Pianarella", "Sweeping seaside slabs and walls of grippy grey limestone, cooled by a sea breeze. The friendly angle and abundant edges make it one of Finale's most enjoyable all-round sectors."],
  ["Finale Ligure", "Grotta dell'Edera", "A shady cave that stays dry in the rain, offering steep tufa pulling and big jugs. When the rest of Finale is wet, this is where everyone heads."],
  ["Gorges du Verdon", "L'Escalès", "The grand wall of the Verdon — long, airy limestone pitches dropping away above the gorge. Committing, exposed and unforgettable, it is the canyon's signature multi-pitch arena."],
  ["Gorges du Verdon", "Le Duc", "Steep pockets and tufas with the turquoise river far below. The climbing is athletic and the position spectacular, with a real sense of the void beneath your heels."],
  ["Kyparissi", "Watermill", "Shaded grey walls beside the spring, with clean rock and friendly grades. A relaxed, family-friendly sector ideal for warming up or escaping a hot afternoon."],
  ["Kyparissi", "Babala", "Sun-soaked tufa walls overlooking the bay, steeper and more sustained than the village crags. Long, breezy lines reward endurance and a head for exposure above the sea."],
  ["Meteora", "Holy Spirit", "An adventurous tower of rounded conglomerate cobbles, climbed on long, boldly protected pitches. Pure adventure for those with a steady head and a taste for the unusual."],
  ["Meteora", "Doupiani", "The beginner-friendly tower near the village, with sweeping views over the monasteries and plain. Mellower pebble climbing makes it the natural place to taste Meteora's surreal rock."],
  ["Saint-Léger-du-Ventoux", "Le Pilier", "Compact, pockety limestone offering technical, fingery climbing with afternoon shade. Precise footwork and a tolerance for small holds are the keys to this Saint-Léger favourite."],
  ["Saint-Léger-du-Ventoux", "La Grotte", "A small, steep cave that stays dry in the rain — powerful and burly. Roofs, tufas and big moves make it both the bad-weather option and a strength session in one."],
  ["San Vito Lo Capo", "Salinella", "Golden limestone steps rising right behind the beach, with sea views and sun. Easy access and approachable grades make it a perfect introduction to San Vito's rock."],
  ["San Vito Lo Capo", "El Bahira", "A south-facing crag near the campsite, dry and warm through winter. Solid, featured walls with a powerful crux or two reward a midday or sunset session."],
  ["Sperlonga", "Grotta", "Sperlonga's steep, shaded sea cave — dark, powerful and dripping with tufas. The signature venue for hard winter sport climbing above the Tyrrhenian."],
  ["Sperlonga", "Settore Centrale", "Vertical to gently overhanging walls with quick roadside access. Clean grey rock and a spread of mid grades make it the sector's reliable all-rounder."],
  ["Val di Mello", "Scoglio delle Metamorfosi", "Yosemite-style granite slabs and cracks rising above the valley's meadows. Long, committing trad lines reward friction, faith and careful gear placement."],
  ["Val di Mello", "Sasso di Remenno", "A giant freestanding granite boulder, the beating heart of the Melloblocco festival. Glassy slopers, crimps and aretes draw boulderers from across Europe."],
];
