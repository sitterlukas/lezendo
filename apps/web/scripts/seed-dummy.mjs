...
async function main() {
  ...
  for (const u of [
    {
      key: "admin",
      email: "admin@whipperbook.test",
      name: "Ada Admin",
      role: "admin",
    },
    {
      key: "lukas",
      email: "lukas@whipperbook.test",
      name: "Lukas Climber",
      role: "member",
    },
    {
      key: "mara",
      email: "mara@whipperbook.test",
      name: "Mara Boulder",
      role: "member",
    },
  ]) {
  ...
  console.log(
    `Created ${Object.keys(users).length} users (password: "password").`,
  );
      ...
      sectors: [
        {
          ...
          routes: [
            ...
            },
            {
              ...
              system: FRENCH,
              description:
                "Sustained vertical climbing up water-worn pockets to the headwall.",
            },
          ],
        },
        {
          ...
          routes: [
            {
              ...
              system: FRENCH,
              description:
                "Relentless three-dimensional climbing up orange tufas.",
            },
            {
              name: "Arcobaleno",
              grade: "7a",
              ...
              system: FRENCH,
              description:
                "Juggy overhang to a slabby finish — burly for the grade.",
            },
          ],
        },
      ],
          ...
          routes: [
            {
              ...
              system: FRENCH,
              description:
                "Wild tufa pinching through the right side of the cave.",
            },
            {
              name: "Aegialis",
              grade: "7b+",
              ...
              system: FRENCH,
              description:
                "Long, pumpy stalactite climbing — read the kneebar rests or melt.",
            },
          ],
        },
        {
          name: "Odyssey",
          description:
            "Vertical to slightly overhanging walls with sea views and morning shade.",
          routes: [
            {
              name: "Priapos",
              grade: "6b",
          ...
          routes: [
            {
              ...
              system: VSCALE,
              description:
                "The first-ever 6a — a Font rite of passage on the Cuvier slab.",
            },
            {
              name: "L'Abattoir",
              grade: "V5",
              ...
              system: VSCALE,
              description:
                "Powerful overhang on sandstone slopers and pinches.",
            },
          ],
        },
        {
          ...
          description:
            "A scenic sector with slabs, aretes and a famous traverse circuit.",
          routes: [
            {
              name: "L'Angle Ben's",
              grade: "V2",
            ...
            },
            {
              ...
              system: VSCALE,
              description:
                "Committing dyno-ish move off slopers — the sector testpiece.",
            },
          ],
        },
      ],
    ...
    for (let i = climber % 3; i < allRoutes.length; i += 2) {
      ...
      await pool.query(
        ...
        [
          r.id,
          climber,
          tickTypes[(i + climber) % tickTypes.length],
          (i * 7) % 90,
  ...
  const gear = [
    {
      user: users.lukas,
      name: "Mammut 9.5 Crag Classic",
      category: "rope",
      brand: "Mammut",
      notes: "70m single, workhorse.",
    },
    {
      user: users.lukas,
      name: "Petzl Spirit",
    ...
    },
    {
      ...
      category: "shoes",
      brand: "La Sportiva",
      notes: "Bouldering go-to.",
    },
    {
      user: users.mara,
      name: "Black Diamond Mondo",
      category: "bouldering",
      brand: "Black Diamond",
      notes: "Huge highball pad.",
    },
    {
      user: users.admin,
      name: "Edelrid Ohm",
      category: "safety",
      brand: "Edelrid",
      notes: "For big weight differences.",
    },
  ];
  for (const g of gear) {
    await pool.query(
      ...
      [
        ...
        g.category,
        g.brand,
        200 + Math.floor(g.name.length * 5),
        g.notes,
      ],
    );
  }
  ...
  const reviews = [
    {
      ...
      rating: 5,
      body: "Stiff edging machine, holds up to multiple resoles.",
    },
    {
      user: users.mara,
      product: "La Sportiva Solution",
      rating: 4,
      body: "Incredible on overhangs, a touch aggressive for long routes.",
    },
    {
      user: users.admin,
      product: "Edelrid Ohm",
      rating: 5,
      body: "Game changer for belaying lighter partners.",
    },
  ];
  ...
  const topics = [
    {
      user: users.lukas,
      title: "Best time of year for Kalymnos?",
      posts: [
        {
          user: users.lukas,
          body: "Thinking of booking a trip — is October too hot?",
        },
        {
          user: users.mara,
          body: "October is perfect, sea's still warm and the crags get shade.",
        },
        {
          user: users.admin,
          body: "+1 for October. Avoid August unless you like sweating off jugs.",
        },
      ],
    },
    {
      user: users.mara,
      title: "Font slopers — any friction tips?",
      posts: [
        {
          user: users.mara,
          body: "I keep greasing off the Cuvier slopers. Brush + chalk routine?",
        },
        {
          user: users.lukas,
          body: "Climb early when it's cold and dry, and brush every attempt.",
        },
      ],
    },
  ];
