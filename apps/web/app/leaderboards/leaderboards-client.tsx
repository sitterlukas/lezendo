...
import { periods, periodLabel } from "@whipperbook/core";
import { type Period, type Discipline } from "@whipperbook/core";
...
export default function LeaderboardsClient({
  ...
  const { data, isPending, error } = useQuery(
    leaderboardQuery<LeaderboardResponse>(browserApi, { period, discipline }),
  );

  if (isPending) return <LeaderboardsSkeleton />;
  ...
  const { viewerId, rows, myRow } = data;
